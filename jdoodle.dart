...
void main() {
  // Create LANY songs
  Song song1 = Song('Pefect', 'One Direction', 240);
  Song song2 = Song('You & I', 'One Direction', 234);
  Song song3 = Song('Super Far', 'LANY', 221);
  Song song4 = Song('Thru These Tears', 'LANY', 237);
  Song song5 = Song('Die With a Smile', 'Lady Gaga & Bruno Mars', 194);
  Song song6 = Song('Iris', 'Goo Goo Dolls', 223);
